...
Building a clear program structure using Inheritance and Classes.
Handling text files as a database for questions.
Managing an interactive user interface with levels and lifelines (helps).
